  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        let isOwner = false;
        try {
          // IMPORTANT: Only treat as Admin when the user owns the CURRENT account in context.
          // Do NOT fall back to "ownsAny" to avoid managers with personal placeholder accounts being shown as Admin.
          if (acc) {
