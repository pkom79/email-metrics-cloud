...
export default function TermsPage() {
    return (
        <div className="prose dark:prose-invert max-w-3xl">
            ...
            <h2 className="mt-10">3. Accounts &amp; Access</h2>
            ...
            <h2 className="mt-10">4. Acceptable Use</h2>
            <ul className="list-disc pl-6">
            ...
            <h2 className="mt-10">5. Data &amp; Privacy</h2>
            ...
            <h2 className="mt-10">6. Intellectual Property</h2>
            ...
            <h2 className="mt-10">7. Availability &amp; Support</h2>
            ...
            <h2 className="mt-10">8. Disclaimers</h2>
            ...
            <h2 className="mt-10">9. Limitation of Liability</h2>
            ...
            <h2 className="mt-10">10. Indemnification</h2>
            ...
            <h2 className="mt-10">11. Termination</h2>
            ...
            <h2 className="mt-10">12. Changes</h2>
