...
export const metadata = {
    title: 'Report Export Guide | Email Metrics',
    description: 'Step-by-step guide to exporting Klaviyo reports (subscribers, flows, campaigns) and preparing CSVs for Email Metrics.'
};

// Re-export the existing tutorial content (duplicated then adjusted headline) by importing the old file code if needed.
// Simpler: copy current implementation from old path (with already removed buttons) and adjust heading.
...
export default function ReportExportGuidePage() {
    ...
    return (
        <article className="relative">
            <header className="mb-10">
                <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-4">Report Export Guide</h1>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 max-w-2xl leading-relaxed">
                    Prepare and export your Klaviyo CSV reports exactly as outlined below. CSV uploads enable fast, reliable processing for large datasets.
                </p>
            </header>
