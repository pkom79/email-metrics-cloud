...
- Interaction: collapse the detailed guidance behind a purple text button labeled “View guidance”/“Hide guidance” with a chevron (`rotate-180` when expanded). Summary stays visible at all times; button uses `text-xs font-semibold text-purple-600` with focus ring and `aria-expanded`.
